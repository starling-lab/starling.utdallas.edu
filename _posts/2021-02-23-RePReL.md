...
<div align="center" >
        ...
        <p style="text-align:center;">Abstract representations for Taxi domain with multipl passengers; high level planner doesn't see the whole map and lower level RL agent doesn't see other passenger locations</p>
</div>  
<br>  
